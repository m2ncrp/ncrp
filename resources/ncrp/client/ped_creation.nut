addEventHandler("onServerClientStarted", function(version) {
    ...
    local pedsArray = [
        [145,   -701.234,   1454.73,   -6.84671,       80.0,   -0.000400906,   -0.00015495, "Robert Casey"  ], // ped for truck job. Placed in Kingston under Red Bridge.
        ...
        [116,   -122.331,  -62.9116,    -12.041,    45.2061,    0.000169911,   -0.00273992, "Sara Johnson"    ], // ped at Car Dealer
