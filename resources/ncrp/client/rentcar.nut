...
addEventHandler("onServerClientStarted", function(...){
	window =  guiCreateElement( ELEMENT_TYPE_WINDOW, "", -9999.0, -9999.0, 270.0, 90.0 );
	label =	guiCreateElement( ELEMENT_TYPE_LABEL, "", 20.0, 20.0, 300.0, 40.0, false, window);
	buttons[0] = guiCreateElement(  ELEMENT_TYPE_BUTTON, "", 20.0, 60.0, 115.0, 20.0,false, window);
	buttons[1] = guiCreateElement(  ELEMENT_TYPE_BUTTON, "", 140.0, 60.0, 115.0, 20.0,false, window);
