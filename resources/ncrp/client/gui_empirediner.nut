...
addEventHandler("showShopGUI", function() {
    ...
    if (window) {
        ...
        guiSetPosition(window,screen[0]/2 - 285.0, screen[1]/2 - 274.0);
        guiSetVisible( window, true);
    }
    // if widow doesn't created, create his
    else {
        window   =  guiCreateElement( ELEMENT_TYPE_WINDOW, "TITLE", screen[0]/2 - 285.0, screen[1]/2 - 274.0, 280.0, 548.0);
