...
function empireDiner(){
    ...
    items[0] =  guiCreateElement( ELEMENT_TYPE_IMAGE, "empirediner.png", 10.0, 20.0, 64.0, 64.0, false, window);
    items[1] =  guiCreateElement( ELEMENT_TYPE_IMAGE, "empirediner.png", 10.0, 20.0, 64.0, 64.0, false, window);
    items[2] =  guiCreateElement( ELEMENT_TYPE_IMAGE, "empirediner.png", 10.0, 20.0, 64.0, 64.0, false, window);
    items[3] =  guiCreateElement( ELEMENT_TYPE_IMAGE, "empirediner.png", 10.0, 20.0, 64.0, 64.0, false, window);
