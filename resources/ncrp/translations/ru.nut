...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
    ...
    "tips.switchchats"  :   "[TIPS] Для переключения между чатами используйте клавиши F1-F4."

/* ------------------------------------------------------------------------------------------------------------------------------------------------------------ */

    "auth.wrongname"        : "Извините, имя аккаунта не может быть меньше 4 символов. Использовать можно английские буквы, цифры, пробел и нижнее подчеркивание."
