...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
    ...
    "job.bus.letsgo"                    :   "[BUS] Подойди к центральной двери здания автобусного вокзала в Аптауне."
    ...
    "job.bus.driver.already"            :   "[BUS] Ты уже работаешь водителем автобуса."
    "job.bus.driver.now"                :   "[BUS] Ты стал водителем автобуса! Поздравляем!"
    "job.bus.ifyouwantstart"            :   "[BUS] Ты работаешь водителем автобуса. Если хочешь выйти в рейс - выбери маршрут на автобусном вокзале."
    "job.bus.route.needselect"          :   "[BUS] Тебе необходимо выбрать маршрут."
    "job.bus.route.tochange"            :   "[BUS] Для выбора маршрута используй /bus route id"
    "job.bus.route.noexist"             :   "[BUS] Такой маршрут не существует. Выбери доступный маршрут."
    "job.bus.route.selected"            :   "[BUS] Ты выбрал маршрут #%d. Садись в автобус."
    "job.bus.route.needcontinue"        :   "[BUS] Продолжай движение по маршруту."
    "job.bus.route.needcomplete"        :   "[BUS] Заверши маршрут."
    "job.bus.needbus"                   :   "[BUS] Тебе нужен автобус."
    "job.bus.notready"                  :   "[BUS] Ты не готов. Сообщи о готовности выйти в рейс."
    "job.bus.readyalready"              :   "[BUS] Ты уже готов выйти в рейс."
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
    ...
    "turorial.spawn.1"  :  "Эй, привет друг. Я смотрю ты здесь новенький. Если хочешь узнать больше - обращайся ко мне."
    "tutorial.spawn.2"  :  "Ты попал в город под названием Эмпайр Бей. Что бы выжить тут - тебе нужны деньги."
    "tutorial.spawn.3"  :  "Зарабатывать их тут можно разными путями. Некоторые люди выбирают работы, а вот некоторые занимаются преступной деятельностью."
    "tutorial.spawn.4"  :  "Я бы советовал тебе начать с грузчика в порту или на вокзале. Или попробовать устроиться водителем автобуса."
    "tutorial.spawn.5"  :  "Что бы передвигаться по городу можно использовать такси, метро, или арендовать себе машину."
    "tutorial.spawn.6"  :  "О, кстати, так же ты можешь купить свой автомобиль, даже несколько. Но для этого придется потрудиться!"
    "tutorial.spawn.7"  :  "Ну и как бы там ни было, я желаю тебе удачи!"
    "tutorial.spawn.8"  :  "Ах, ты хочешь что бы я рассказал тебе информацию еще раз? Хорошо!"
});
