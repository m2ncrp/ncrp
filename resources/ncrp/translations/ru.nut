...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
    ...
    "vehicle.sell.2passangers"  : "Человек, которму вы хотите продать, должен находится в одном авто с вами."
    "vehicle.sell.ask"          : "%s предлагает вам преобрести это авто за $%.2f."
