...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
    "character.invalid.rpname"      : "Ваш персонаж был создан с неправильным (Нон-РП) именем. Он будет удален. Пожалуйста, пересоздайте персонажа следуя РП правилам."
    "character.doesnotexist"        : "Персонаж с указанными данными не существует."
    "character.alreadymigrated"     : "Указанный персонаж уже был мигрирован."
    "character.limitexceeded"       : "Вы не можете создавать больше персонажей."
    "character.alreadyregistered"   : "Указанная пара Имя и Фамилия занята. Пожалуйста придумайте другие."
    "character.wrongname"           : "Вы указали не правильные Имя или Фамилию. Пожалуйста исправьте и попробуйте снова."
    "character.bannednames"         : "Указанное Имя и/или Фамилия запрещены парвилами сервера. Пожалуйста измените, и попробуйте снова."
});
