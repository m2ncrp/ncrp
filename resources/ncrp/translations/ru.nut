...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
    ...
    "tips.bugreport"    :   "[TIPS] Вы можете отправить баг репорт используя /bug ТЕКСТ"

/* ------------------------------------------------------------------------------------------------------------------------------------------------------------ */

    "auth.wrongname"        : "Простите, имя аккаунта не может быть меньше 4 символов содержать ничего кроме английских букв, цифр, пробела и нижнего подчеркивания."
