...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
    ...
    "help.fuel"        : "Показать список команд для заправных станций"
    "help.repair"      : "Показать список команд для автомастерских"
    "help.report"      : "Сообщить о игроке нарушающем правила/читере"
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
    ...
    "help.chat.try"         : "Сообщить о попытке выполенения дейсвтия, со случайным результатом"
