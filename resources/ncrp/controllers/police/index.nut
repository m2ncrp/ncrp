...
addEventHandler("onScriptInit", function() {
    ...
    createVehicle(21, -324.293, 693.31, -16.3, -179.993, -0.874155, -0.173508 ); // policeBusParking1
    createVehicle(51, -327.4, 658.222, -16.0, 91.789, -3.43091, -0.15915 ); // policeOldCarParking1
    createVehicle(51, -327.4, 663.151, -16.0, 91.364, -2.96305, -0.208081 ); // policeOldCarParking2
})
