local passangerPositions = [
    [-0.386, 3.255,  -0.4332],  // 0
    [0.183,  3.215,  -0.4421],  // 1
    [-0.389, 1.465,  -0.7379],  // 2
    [0.257,  1.513,  -0.4479],  // 3
    [-0.391, 0.593,  -0.4399],  // 4
    [0.234,  0.608,  -0.4497],  // 5
    [-0.394, -0.608, -0.4428],  // 6
    [0.239,  -0.618, -0.4531],  // 7
    [-0.901, -1.962, -0.4405],  // 8
    [0.298,  -2.314, -0.4611],  // 9
    [-0.393, -2.269, -0.4519],  // 10
    [0.296,  -3.712, -0.4631]   // 11
];
