...
class Item.MK2              extends Item.Weapon { static classname = "Item.MK2";            constructor () { base.constructor(); this.weight = 0.600; this.model = 07 }}
class Item.Remington870     extends Item.Weapon { static classname = "Item.Remington870";   constructor () { base.constructor(); this.weight = 3.600; this.model = 08 }}
class Item.M3GreaseGun      extends Item.Weapon { static classname = "Item.M3GreaseGun";    constructor () { base.constructor(); this.weight = 3.500; this.model = 09 }}
class Item.MP40             extends Item.Weapon { static classname = "Item.MP40";           constructor () { base.constructor(); this.weight = 4.700; this.model = 10 }}
class Item.Thompson1928     extends Item.Weapon { static classname = "Item.Thompson1928";   constructor () { base.constructor(); this.weight = 4.900; this.model = 11 }}
class Item.M1A1Thompson     extends Item.Weapon { static classname = "Item.M1A1Thompson";   constructor () { base.constructor(); this.weight = 4.800; this.model = 12 }}
class Item.Beretta38A       extends Item.Weapon { static classname = "Item.Beretta38A";     constructor () { base.constructor(); this.weight = 3.300; this.model = 13 }}
class Item.MG42             extends Item.Weapon { static classname = "Item.MG42";           constructor () { base.constructor(); this.weight = 11.50; this.model = 14 }}
class Item.M1Garand         extends Item.Weapon { static classname = "Item.M1Garand";       constructor () { base.constructor(); this.weight = 4.300; this.model = 15 }}
class Item.Kar98k           extends Item.Weapon { static classname = "Item.Kar98k";         constructor () { base.constructor(); this.weight = 3.900; this.model = 17 }}
class Item.Molotov          extends Item.Weapon { static classname = "Item.Molotov";        constructor () { base.constructor(); this.weight = 1.000; this.model = 21 }}
