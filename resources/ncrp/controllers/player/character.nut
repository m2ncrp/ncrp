 ...
 */
event("onPlayerCharacterCreate", function(playerid, id, firstname, lastname, race, sex, birthdate, cskin) {
    dbg("trying to create character with", id, firstname, lastname, race, sex, birthdate, cskin);
});
/**
