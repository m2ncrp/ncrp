...
translate("en", {
    "shops.findcar.hello"  : "[CALL] Empire Bay Car Searching Services. We can find all your cars. It's cost $%.2f."
    ...
    "shops.findcar.nomoney" : "[CALL] Sorry, you don't have enough money. Good bye."
});
