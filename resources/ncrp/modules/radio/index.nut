...
translation("ru", {
    ...
    "radio.vangel"          :   "Пора обновить гардероб? Ателье Вэнджела в Мидтауне ждёт Вас!"
    ...
    "radio.swiftcola"       :   "Спонсор сегодняшнего матча Swift Cola. Пей Swift Cola!"
    ...
    "radio.ricky"           :   "Все хиты для танцев и частных вечеринок. Студия звукозаписи Ricky."
