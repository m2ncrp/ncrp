...
event ("onServerStarted", function() {
    ...
    rentcars[createVehicle(43, 579.762, 802.5, -12.5, 34.939,  0.37609, -0.0309878)]    <- [ 0.05, "free" ];
    rentcars[createVehicle(53, 575.099, 802.5, -12.5, 36.7076, 0.287637, 0.0469708)]    <- [ 0.06, "free" ];
    rentcars[createVehicle(44, 570.128, 802.5, -12.5, 38.578,  0.206956, -0.591333)]    <- [ 0.15, "free" ];
    rentcars[createVehicle(50, 565.087, 802.5, -12.5, 40.5424, 0.668225, -0.409561)]    <- [ 0.17, "free" ];
    rentcars[createVehicle(15, 560.053, 802.5, -12.5, 42.1816, 0.300678, 0.0441727)]    <- [ 0.23, "free" ];
    rentcars[createVehicle(41, 554.652, 802.5, -12.5, 38.7988, 0.134398, -0.381655)]    <- [ 0.26, "free" ];
    rentcars[createVehicle(10, 548.724, 802.5, -12.5, 45.0359, 0.392815, 0.00316114)]   <- [ 0.63, "free" ];

    // Vokzal
    rentcars[createVehicle(43, -547.328, 1583.16, -16.3215, 1.03211, 0.00669244, -0.743004)]  <- [ 0.05, "free" ];
    rentcars[createVehicle(53, -539.312, 1600.12, -16.3687, -179.923, -0.285566, 0.826165)]   <- [ 0.06, "free" ];
    rentcars[createVehicle(52, -536.281, 1599.85, -16.4633, -179.624, -0.121403, 0.225714)]   <- [ 0.40, "free" ];

    //Port
    rentcars[createVehicle(43, -419.388, -667.238, -20.8829, 87.5226, -0.29715, -1.18796)]  <- [ 0.05, "free" ];
    rentcars[createVehicle(44, -419.57, -670.935, -21.0624, 88.1328, -0.25944, -1.9095)]    <- [ 0.15, "free" ];
    rentcars[createVehicle(23, -419.314, -677.798, -21.2509, -93.2246, 0.213046, -2.23081)] <- [ 0.20, "free" ];
