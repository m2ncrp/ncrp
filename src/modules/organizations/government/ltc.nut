...
alternativeTranslate({
    ...
    "en|ltc.needsolution"      : "Contact the government official (not NPC) for obtaining a LTC."
    "ru|ltc.needsolution"      : "Для получения лицензии на оружие обратитесь к сотруднику мэрии (реальному живому игроку)."

    "en|ltc.countdown"         : "The length of your stay in Empire Bay is insufficient to obtain a LTC."
    ...
    "en|ltc.solution.approved" : "You have approved the application for obtaining a LTC."
    "ru|ltc.solution.approved" : "Вы одобрили заявку на получение лицензии на оружие."

    "en|ltc.solution.rejected" : "You have rejected/approved the application for obtaining a LTC."
