alternativeTranslate({
    ...
    "ru|parking.carNotParked"      : "Этот автомобиль отсутствует на штрафстоянке."
    "ru|parking.notenoughmoney"    : "Недостаточно денег на банковском счёте."
    "ru|parking.notYourCar"        : "Этот автомобиль вам не принадлежит."
    "ru|parking.needPay"           : "Вы сможете завести двигатель, когда оплатите штраф."
