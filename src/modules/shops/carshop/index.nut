...
local carPricesAll = [
    [   // diamond motors
        { modelid = 0  , price = 7100 , rent = 0.84, title = "Ascot Bailey S200"            },
        { modelid = 1  , price = 6125 , rent = 0.71, title = "Berkley Kingfisher"           },
        { modelid = 9  , price = 2510 , rent = 0.42, title = "Houston Wasp"                 },
        { modelid = 10 , price = 9800 , rent = 1.08, title = "ISW 508"                      },
        { modelid = 12 , price = 2100 , rent = 0.34, title = "Walter Utility"               },
        { modelid = 13 , price = 14700, rent = 2.75, title = "Jefferson Futura"             },
        { modelid = 14 , price = 5050 , rent = 0.61, title = "Jefferson Provincial"         },
        { modelid = 15 , price = 2800 , rent = 0.46, title = "Lassiter Series 69"           },
        { modelid = 18 , price = 7870 , rent = 0.89, title = "Lassiter Series 75 Hollywood" },
        { modelid = 22 , price = 1900 , rent = 0.32, title = "Potomac Indian"               },
        { modelid = 23 , price = 1500 , rent = 0.28, title = "Quicksilver Windsor"          },
        { modelid = 25 , price = 650  , rent = 0.17, title = "Shubert 38"                   },
        { modelid = 28 , price = 3200 , rent = 0.36, title = "Shubert Beverly"              },
        { modelid = 29 , price = 5575 , rent = 0.56, title = "Shubert Frigate"              },
        { modelid = 31 , price = 920  , rent = 0.17, title = "Shubert 38 Panel Truck"       },
        { modelid = 41 , price = 3800 , rent = 0.38, title = "Smith Custom 200"             },
        { modelid = 43 , price = 295  , rent = 0.15, title = "Smith Coupe"                  },
        { modelid = 44 , price = 1650 , rent = 0.27, title = "Smith Mainline"               },
        { modelid = 45 , price = 4500 , rent = 0.58, title = "Smith Thunderbolt"            },
        { modelid = 47 , price = 570  , rent = 0.16, title = "Smith V8"                     },
        { modelid = 48 , price = 1580 , rent = 0.26, title = "Smith Deluxe Station Wagon"   },
        { modelid = 50 , price = 1850 , rent = 0.31, title = "Culver Empire"                },
        { modelid = 52 , price = 4150 , rent = 0.60, title = "Walker Rocket"                },
        { modelid = 53 , price = 410  , rent = 0.15, title = "Walter Coupe"                 },
