alternativeTranslate({
    ...
    "en|job.snowplow.goodluck"                  :   "Good luck, guy! Come if you need a job."
    "ru|job.snowplow.goodluck"                  :   "Удачи тебе! Приходи, если нужна работа."

    "en|job.snowplow.driver.not"                :   "You're not a snowplow driver."
    "ru|job.snowplow.driver.not"                :   "Ты не работаешь водителем снегоуборочной машины."

    "en|job.snowplow.driver.now"                :   "You're a snowplow driver now! Congratulations!"
    "ru|job.snowplow.driver.now"                :   "Ты стал водителем снегоуборочной машины!"
    ...
    "en|job.snowplow.ifyouwantstart"            :   "You're snowplow driver. If you want to start route - take route at snowplow depot in Uptown."
    "ru|job.snowplow.ifyouwantstart"            :   "Ты работаешь водителем снегоуборочной машины. Если хочешь выйти в рейс - возьми маршрут."

    "en|job.snowplow.takeyourmoney"             :   "Take your money."
    "ru|job.snowplow.takeyourmoney"             :   "Забери деньги за работу."

    "en|job.snowplow.route.your"                :   "Your route:"
    "ru|job.snowplow.route.your"                :   "Твой текущий маршрут:"

    "en|job.snowplow.startroute"                :   "Sit into snowplow truck and drive along the route."
    "ru|job.snowplow.startroute"                :   "Садись в снегоуборочную машину и следуй по маршруту."
    ...
    "en|job.snowplow.route.needcomplete"        :   "Complete current route."
    "ru|job.snowplow.route.needcomplete"        :   "Заверши маршрут."

    "en|job.snowplow.needCompleteToLeave"       :   "You need to complete current route to leave job."
    "ru|job.snowplow.needCompleteToLeave"       :   "Чтобы уволиться, тебе надо завершить текущий маршрут."

    "en|job.snowplow.needsnowplow"              :   "You need a snowplow truck."
    "ru|job.snowplow.needsnowplow"              :   "Тебе нужна снегоуборочная машина."

    "en|job.snowplow.continuesnowplowstop"      :   "Continue the route."
    "ru|job.snowplow.continuesnowplowstop"      :   "Продолжай движение по маршруту."


    "en|job.snowplow.driving"                   :   "Reduce speed."
    "ru|job.snowplow.driving"                   :   "Снизь скорость."

    "en|job.snowplow.gototakemoney"             :   "Leave the snowplow truck and take your money."
    "ru|job.snowplow.gototakemoney"             :   "Вылезай из машины и забирай деньги за работу."

    "en|job.snowplow.nicejob"                   :   "Nice job! You earned $%.2f"
    "ru|job.snowplow.nicejob"                   :   "Отличная работа! Ты заработал $%.2f."
