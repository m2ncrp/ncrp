...
// FirstChurchofChrist, Scientist http://www.nycago.org/Organs/NYC/html/FirstCS.html
   ...
   //routes[5] <- [23, [4, 5, 99, 6, 7, 8, 9, 10, 12, 13, 16, 18, 20, 22, 23, 24, 21, 19, 17, 14, 15, 4]];
    ...
    routes[1] <- [10, [51, 5, 57, 7, 28, 97, 22, 23, 24, 52]];                                               // sand island
    routes[2] <- [8, [55, 21, 19, 17, 14, 15, 55]];                                                         // uptown-kingston
    routes[3] <- [11, [53, 58, 59, 6, 7, 8, 9, 10, 11, 13, 45, 54]];                                         // center + hospital
    routes[4] <- [14, [51, 44, 25, 16, 18, 48, 20, 22, 23, 24, 21, 47, 46, 52]];                             // kingston
    routes[5] <- [17, [4, 26, 27, 28, 7, 8, 9, 10, 12, 13, 16, 18, 20, 22, 23, 24, 21, 19, 17, 14, 15, 4]];  // big empire bay
    routes[6] <- [14, [56, 33, 9, 34, 35, 36, 37, 49, 28, 29, 30, 38, 40, 41, 56]];                          // new center
    routes[7] <- [7.5, [54, 42, 39, 31, 32, 43, 54]];                                                         // small
