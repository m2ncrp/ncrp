alternativeTranslate({
    ...
    "ru|job.truckdriver.scens8.unload"     : "Грузовик загружен. Отправляйся к литейной в Северный Милвилл для выгрузки руды."

    "ru|job.truckdriver.scens9.load"       : "На пристани заканчивается топливо для катеров. Садись в открытый грузовик %s и отправляйся на угольный склад в Северном Милвилле."
    ...
    "ru|job.truckdriver.needlevel"         : "Шофёром можно устроиться начиная с уровня %d."
    "ru|job.truckdriver.wantwork"          : "Ты работаешь шофёром. Если хочешь поработать - отправляйся к транспортной базе у моста в Хайбрук."
    "ru|job.truckdriver.already"           : "Ты уже работаешь шофёром."
    "ru|job.truckdriver.notpassenger"      : "Доставка может осуществляться только водителем, но не пассажиром."
    "ru|job.truckdriver.loading"           : "Грузовик загружается. Подожди..."
    "ru|job.truckdriver.unloading"         : "Грузовик разгружается. Подожди..."
    "ru|job.truckdriver.alreadyloaded"     : "Грузовик уже загружен."
    "ru|job.truckdriver.empty"             : "Грузовик пуст."
    "ru|job.truckdriver.needparking"       : "Возвращайся на базу к мосту в Хайбрук и оставь грузовик на специальной парковке."
    "ru|job.truckdriver.takemoney"         : "Выходи из грузовика и иди за деньгами к Роберту."
    ...
    "en|job.truckdriver.scens8.unload"     : "Грузовик загружен. Отправляйся к литейной в Северный Милвилл для выгрузки руды."

    "en|job.truckdriver.scens9.load"       : "На пристани заканчивается топливо для катеров. Садись в открытый грузовик %s и отправляйся на угольный склад в Северном Милвилле."
