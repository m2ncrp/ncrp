...
translation("en", {
    ...
    "tips.money.bank"   :   "[TIPS] You can earn money by starting bank deposit. Go to the bank (icon with dollar on the map)."
    "tips.car"          :   "[TIPS] You can buy own car at the Diamond Motors (colored icon with car on the map)."
    ...
    "tips.discord"      :   "[TIPS] You can follow our development updates on the official discord server: bit.ly/m2ncrp"
