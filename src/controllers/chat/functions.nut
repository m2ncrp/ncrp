...
function sendPlayerPrivateMessage(playerid, targetid, vargv) {
    ...
    msg(playerid, "chat.player.message.private.from", [targetid.tostring(), message], CL_CHAT_PM );
    msg(targetid, "chat.player.message.private.to", [playerid.tostring(), message], CL_CHAT_PM );
